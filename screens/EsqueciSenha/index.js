...
const EsqueciSenha = ({fontsize,fontweight}) => {
    return (
        <Container>
            ...
            <Input width={screenWidth*0.8} placeholder='E-mail' margintop={45}/>
            <Button text='Enviar' width={screenWidth*0.67} height={50} backgroundcolor={colors.silverMotors} border={'none'} radius={30} margintop={50} />
        </Container>
    );
};
