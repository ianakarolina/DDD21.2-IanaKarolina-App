...
const Login = ({fontstyle,textdecoration,marginleft,margintop}) => {
    return (
        <Container>
            ...
            <OrText> ──────── Ou ──────── </OrText>
            <Button text='GOOGLE' width={screenWidth*0.79} height={35} backgroundcolor={colors.background} border={colors.secundaria} radius={5} margintop={15}/>
            <Button text='FACEBOOK' width={screenWidth*0.79} height={35} backgroundcolor={colors.background} border={colors.secundaria} radius={5} margintop={15} />
            <SignUpButton marginleft={0} margintop={5}>
